const translations = {
  ru: {
    ...
    "intro.badge1": "Бакалавр",
    "intro.badge2": "Инженер по инфраструктуре",
    "intro.badge3": "Практический опыт в production",
    "intro.text": "Проектирую и поддерживаю IT-инфраструктуру: сети, серверы и безопасность без простоев.",
    "why.title": "Почему я",
    "why.text": "Даю бизнесу не просто «настройку», а предсказуемый результат: прозрачные сроки, понятная коммуникация, аккуратная документация и решения, которые действительно работают в реальной нагрузке. Быстро вхожу в проект, думаю на шаг вперёд и отвечаю за стабильность после запуска.",
    "about.label": "Позиционирование",
    "about.title": "Инженер, который соединяет безопасность, сеть и разработку в одну рабочую систему.",
    "about.text": "Проектирую и обслуживаю IT-инфраструктуру под реальные бизнес-задачи: сеть, серверы, безопасность, автоматизация рутин и резервное копирование.",
  ...
  en: {
    ...
    "intro.badge1": "Bachelor's degree",
    "intro.badge2": "Infrastructure Engineer",
    "intro.badge3": "Hands-on production experience",
    "intro.text": "I design and support IT infrastructure: networks, servers, and security with zero unnecessary downtime.",
    "why.title": "Why me",
    "why.text": "I deliver more than setup: I deliver predictable outcomes for business with clear timelines, straightforward communication, clean documentation, and solutions that hold up under real load. I onboard fast, think ahead, and take responsibility for stability after launch.",
    "about.label": "Positioning",
    "about.title": "Engineer connecting security, networking and development into one reliable system.",
    "about.text": "I design and support IT infrastructure for real business needs: networking, servers, security, routine automation and backup reliability.",
